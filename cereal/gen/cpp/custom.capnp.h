...
enum class EventName_b8007ed8a646b5e6: uint16_t {
  ...
  SPEED_LIMIT_PENDING,
  E2E_CHIME,
  RIVIAN_MADS_RESUME_WARNING1_SEC,
  RIVIAN_MADS_RESUME_WARNING2_SEC,
  RIVIAN_MADS_RESUME_WARNING3_SEC,
  RIVIAN_MADS_RESUME_WARNING4_SEC,
  RIVIAN_MADS_RESUME_WARNING5_SEC,
  RIVIAN_PILOT_LANE_CORRECTION_AHEAD_LEFT,
  RIVIAN_PILOT_LANE_CORRECTION_AHEAD_RIGHT,
  RIVIAN_MADS_LOW_SPEED_BLINKER_PAUSE,
  RIVIAN_PILOT_VISION_B_S_M_BLOCKED,
  RIVIAN_PILOT_VISION_B_S_M_BLOCKED_LOUD,
  RIVIAN_PILOT_VISION_B_S_M_DETECTED_LEFT,
  RIVIAN_PILOT_VISION_B_S_M_DETECTED_RIGHT,
  RIVIAN_PILOT_VISION_B_S_M_DETECTED_LEFT_LOUD,
  RIVIAN_PILOT_VISION_B_S_M_DETECTED_RIGHT_LOUD,
  RIVIAN_PILOT_VISION_B_S_M_READY,
  RIVIAN_PILOT_NUDGE_TIMER,
  RIVIAN_PILOT_ACTIVE_OFFSET,
};
