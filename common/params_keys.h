...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"RivianPilotVisionBSMAnnotationConfig", {PERSISTENT | BACKUP, JSON, "{}"}},
    {"RivianPilotVisionBSMLeftActive", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    {"RivianPilotVisionBSMRightActive", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    {"RivianPilotVisionBSMLeftConfidence", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"RivianPilotVisionBSMRightConfidence", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"RivianPilotVisionBSMLastUpdateMonoTime", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"RivianPilotVisionBSMBlockedSide", {CLEAR_ON_MANAGER_START, STRING, ""}},
    {"RivianPilotVisionBSMBlockedAt", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
