...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"RivianPilotVisionBSMLastUpdateMonoTime", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, FLOAT, "0.0"}},
    {"RivianPilotVisionBSMLeftActive", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, BOOL, "0"}},
    {"RivianPilotVisionBSMRightActive", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, BOOL, "0"}},
    {"RivianPilotVisionBSMLeftConfidence", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, FLOAT, "0.0"}},
    {"RivianPilotVisionBSMRightConfidence", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, FLOAT, "0.0"}},
    ...
    {"RivianPilotAdaptiveCenterCorrection", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"RivianPilotCenterMinimumSpeed", {PERSISTENT | BACKUP, INT, "15"}},
    {"RivianPilotCenterFullSpeed", {PERSISTENT | BACKUP, INT, "30"}},
    {"RivianPilotCenterHighwaySpeed", {PERSISTENT | BACKUP, INT, "55"}},
    {"RivianPilotHighwayCenterCorrectionInches", {PERSISTENT | BACKUP, INT, "3"}},
    ...
    {"RivianPilotLaneCorrectionAlert", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"RivianPilotLaneCorrectionAlertDirection", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, STRING, ""}},
    {"RivianPilotLaneCorrectionAlertInches", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, INT, "0"}},
    {"RivianPilotLaneCorrectionAlertAt", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, FLOAT, "0.0"}},
    {"RivianPilotNudgeTimerDirection", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, STRING, ""}},
    {"RivianPilotNudgeTimerRemaining", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, INT, "0"}},
    {"RivianPilotNudgeTimerHeartbeat", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, FLOAT, "0.0"}},
    {"RivianPilotActiveOffsetTitle", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, STRING, ""}},
    {"RivianPilotActiveOffsetDetail", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, STRING, ""}},
    {"RivianPilotActiveOffsetHeartbeat", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, FLOAT, "0.0"}},
